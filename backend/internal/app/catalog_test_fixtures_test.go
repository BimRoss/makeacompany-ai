	...
	return CapabilityCatalog{
		...
		Skills: []CapabilityCatalogSkill{
			...
			},
			{
				ID:             "update-issue",
				Label:          "Update Issue",
				Description:    "Update a GitHub issue by number (title/body) and optionally set project status on the BimRoss kanban board.",
				RuntimeTool:    "ross-update-issue",
				RequiredParams: []string{"number"},
				OptionalParams: []string{"repository", "title", "body", "status"},
				Requires:       []string{"github_api"},
			},
		},
