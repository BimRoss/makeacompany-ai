...
/**
 * Same orchestrator proxy as /api/admin/slack-member-channels, but requires a portal session
 * so company owners see private/public on `/[channelId]` without admin access.
 */
