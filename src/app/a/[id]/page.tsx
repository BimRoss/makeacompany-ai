    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <section className="flex flex-col items-center gap-4">
        <a
          ...
          target="_blank"
          rel="noopener"
          className="inline-flex min-h-12 w-full items-center justify-center rounded-lg bg-foreground px-8 text-base font-semibold text-background transition hover:opacity-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground/40 sm:w-auto"
        >
          Build your agent
        </a>
