...
export function ObservabilityToolbar({ lastUpdatedAt, loading }: ToolbarProps) {
  ...
  return (
    <div className="sticky top-0 z-10 -mx-3 mb-2 flex flex-wrap items-center justify-between gap-2 border-b border-border bg-background/80 px-3 py-2 backdrop-blur sm:-mx-6 sm:px-6">
