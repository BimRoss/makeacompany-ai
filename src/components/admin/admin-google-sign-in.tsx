export function AdminGoogleSignIn() {
  const href = "/api/admin/auth/google/start";
  return (
    <a
      href={href}
      className="inline-flex h-12 w-full max-w-md items-center justify-center gap-2 rounded-xl border border-border bg-white px-4 text-base font-semibold text-foreground shadow-sm transition hover:bg-muted/40 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground/30 dark:bg-zinc-950 dark:hover:bg-zinc-900"
    >
