// Personal-scope Google sign-in button (#199). Cid-less twin of
// PortalGoogleSignIn — points at /api/portal/auth/personal/google/start
// so /me/login can authenticate users without a channel context.

export function PortalPersonalGoogleSignIn() {
  const href = `/api/portal/auth/personal/google/start`;
  return (
    <a
      href={href}
