export function MeGoogleSignIn() {
  return (
    // eslint-disable-next-line @next/next/no-html-link-for-pages -- API route, full document nav required
    <a
      href="/api/me/auth/google/start"
